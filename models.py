...
class NguoiDung(Base):
    ...
    vai_tro = Column(String(20), nullable=False, default="User")
    dang_hoat_dong = Column(Boolean, nullable=False, default=True)
...
class TinDang(Base):
    ...
    loai_tin = Column(String(20), nullable=False)
...
class BaoCaoViPham(Base):
    ...
    trang_thai = Column(String(20), nullable=False, default="cho_xu_ly")
    gui_luc = Column(DateTime, server_default=func.now())
...
class ThongBao(Base):
    ...
    loai_thong_bao = Column(String(30), nullable=False, default="HeThong")
    da_doc = Column(Boolean, default=False)
    ngay_tao = Column(TIMESTAMP, server_default=func.now())
